...
<div class="container mt-5">
    <div class="progress-bar-container">
        <div class="progress-steps">
            ...
            <div class="progress-step-item" data-step="9">9</div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="row m-5">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="tipekos" id="putra"
                                        value="Putra">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="deskripsikos"
                    ...
                    <div class="row m-5">
                        <div class="mb-4">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="parkiran">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="mesinCuci">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="kulkas">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="dapur">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="kamarMandi">
                                ...
                                <div class="col-md-6">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="listrikAir">
                ...
                <div class="card-body">
                    ...
                    <div class="row m-5">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" id="kecamatan" placeholder="Masukkan Kecamatan"
                                    rows="3"></textarea>
                            </div>
                        </div>
                        <div class="mb-3 row">
                ...
                <div class="card-body">
                    <div class="row m-5">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <p class="text-sm text-gray-500 mb-4">Tunjukkan lingkungan kos dari belakang ke calon
                                penyewa.</p>
                            <div class="photo-box">
                                <i class="fas fa-camera"></i>
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <p class="text-sm text-gray-500 mb-4">Tunjukkan lingkungan sekitar depan kos ke calon
                                penyewa.</p>
                            <div class="photo-box">
                                <i class="fas fa-camera"></i>
                ...
                <div class="card-body">
                    <div class="row m-5">
                        ...
                        <div class="button mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <button class="form-control" id="dataketersediaan" onclick="goToStep(7)">Atur
                                    Ketersediaan Kamar</button>
                            </div>
                        </div>
                    </div>
                </div>
